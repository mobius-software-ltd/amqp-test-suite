...
public class CommandCounter extends Counter
{
	...
	public CommandCounter(HeaderCode command, Integer count, Direction direction)
	{
		super(count, direction);
		this.command = command;
	}

	public HeaderCode getCommand()
	{
		return command;
	}

	public void setCommand(HeaderCode command)
	{
		this.command = command;
	}
}
